...
test('Casting object with a date and number', function(t) {
	...
	t.equal(casted.dateProperty.getTime(), 1383181326000, 'matching the date constructed from a unix timestamp')
...
test('Extending a wizard caster with new types/defaults', function(t) {
	...
	t.equal(apprenticeSpell.dateProperty.getTime(), 1383181326000, 'matching the date constructed from a unix timestamp')
	...
	t.equal(spell.dateProperty.getTime(), 1383181326000, 'matching the date constructed from a unix timestamp')
